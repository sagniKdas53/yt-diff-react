...
export default function InputForm({ setParentUrl, setRespStart }) {
    ...
    //const [multiple, toggleMultiple] = useState(false);
        ...
        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
            <div className="container-fluid input-card">
                <div className="row my-2">
                    ...
                    <textarea className="form-control unified-input" rows={urlList.split("\n").length < 12 ? urlList.split("\n").length : 12}
                        placeholder="url list" id="url_list" title="Url List"
                        value={urlList} onChange={updateUrls} />
                </div>
                <div className="row my-2">
                    <div className="col align-items-center m-0 p-0">
                        <div className="m-0 p-0 d-flex flex-row align-items-center">
                            <label className="form-check-label emoji align-items-center">Watch? </label>
                            <FormControl
                ...
                <div className="row mb-2">
                    <div className="col m-0 p-0">
                        <div className="btn-group" role="group">
                            ...
                            <button id="clear_btn" type="button" onClick={clearInput} className="btn btn-primary">Clear</button>
                        </div>
                    </div>
